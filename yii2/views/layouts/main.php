...
<footer class="footer-widget-section">
        ...
        <div class="row">
            <div class="col-md-6">
                <aside class="footer-widget">
                   <h3 class="widget-title text-uppercase text-center">KazahGame</h3>
            ...
            <div class="col-md-5">
                <aside class="footer-widget">
                    <h3 class="widget-title text-uppercase text-center">Testimonials</h3>
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2015 <a href="#">KazahGame, </a> Yii2 <i
                            class="fa fa-heart"></i> by <a href="#">GA</a>
                    </div>
                </div>
            </div>
        </div>
